...
class TestFilterByCurrency:
    ...
    def test_transaction_without_currency(self, sample_transactions: List[Dict[str, Any]]) -> None:
        """Тест обработки транзакций без информации о валюте."""
        # Транзакция с id 123 не имеет operationAmount, должна быть проигнорирована
